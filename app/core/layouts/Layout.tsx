...
import { Head, BlitzLayout, useMutation, Routes } from "blitz"
        ...
        <header className={styles.header}>
          <div className={styles.header__nav}>
            ...
            <div className={styles.header__links}>
              <a href="/catalog" className={styles.header__link}>
                Каталог
              </a>
              <a href="/teach" className={styles.header__link}>
                Преподавание
              </a>
              {currentUser ? (
                <>
